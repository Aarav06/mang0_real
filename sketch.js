...
function detectCollision(lstone, lmango) {
	mango0.body.position = lmango.body.position;
	stone.body.position = lstone.body.position;
	var distance = dist(stone.body.position.x, stone.body.position.y, mango0.body.position.x, mango0.body.position.y);
